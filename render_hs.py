...
def main(argv):
    ...
    envs_dir = 'MAPPO/MAEE/mae_envs/envs'             #改成hide_and_seek.py文件的路径
    xmls_dir = 'xmls'
    ...
    if len(names) >= 2:  # run policies on the environment
        ...
        # environments code.
        from mae_envs.viewer.policy_viewer import PolicyViewer_hs      
        ...
        # actor_critic, ob_rms = torch.load('/home/chenjy/new_version/trained_models/ppo' + args.model_dir + '/agent_%i' % (i+1) + ".pt")
            actor_critic, ob_rms = torch.load('/home/zhangyx/MAPPO/trained_models/ppo/hide and seek_11/agent_1' + ".pt")  #模型文件路径
