ulimit -n 16384
CUDA_VISIBLE_DEVICES=0 python main_cur1_hs.py --env-name "hide_and_seek" --model_dir '/hide and seek' --save-interval 200 --algo ppo --use-gae --lr 2e-3 --clip-param 0.2 --value-loss-coef 0.5 \
