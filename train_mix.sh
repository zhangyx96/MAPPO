CUDA_VISIBLE_DEVICES=7 python main_mix.py --env-name "simple_spread" --model_dir '/run456_policyattention_mix' \
...
--agent_num 5 --ppo-epoch 25 --gae-lambda 0.98 --seed 1 --num-env-steps 500000000  \
